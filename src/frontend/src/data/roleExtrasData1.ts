...
export const roleExtrasData1: Record<string, RoleExtras> = {
  ...
  "data-warehouse-engineer": {
    freeCourses: [
      {
        name: "SQL for Data Warehousing – Full Course",
      ...
      {
        name: "Snowflake Zero to Hero – Complete Tutorial",
        url: "https://www.youtube.com/watch?v=9PBvVeCQi0w",
        provider: "Techgrounds",
        platform: "YouTube",
        language: "English",
        level: "Intermediate",
      },
      ...
      {
        name: "dbt (Data Build Tool) Crash Course",
        url: "https://courses.getdbt.com/courses/fundamentals",
        provider: "dbt Labs",
        platform: "dbt Learn",
        language: "English",
      ...
      {
        name: "Data Warehousing Concepts in Hindi",
        url: "https://www.youtube.com/playlist?list=PLdOKnrf8EcFIBEHoNsVKcN2I8PBkmPBdh",
        provider: "Intellipaat Hindi",
        platform: "YouTube",
        language: "Hindi",
        level: "Beginner",
      },
      {
        name: "SQL & Data Warehouse Telugu Tutorial",
        url: "https://www.youtube.com/c/TeluguTechTuts",
        provider: "Telugu Tech Tuts",
        platform: "YouTube",
        language: "Telugu",
      ...
      {
        name: "Modern Data Warehouse with Azure Synapse",
        url: "https://learn.microsoft.com/en-us/training/paths/realize-integrated-analytical-solutions-with-azure-synapse-analytics/",
        provider: "Microsoft Learn",
        platform: "Microsoft Learn",
        language: "English",
        level: "Intermediate",
    ...
    interviewGuide: {
      revisionTopics: [
        {
          category: "Data Warehouse Fundamentals",
          topics: [
            "Kimball vs Inmon methodology: bottom-up vs top-down data warehouse design",
            "Star schema vs snowflake schema: trade-offs in query performance and storage",
            "Fact tables (additive, semi-additive, non-additive) and dimension tables",
            "Slowly Changing Dimensions: Type 1 (overwrite), Type 2 (history rows), Type 3 (add column)",
            "Grain of a fact table and why it matters for analysis accuracy",
            "Conformed dimensions and conformed facts for enterprise-wide DW consistency",
          ],
        },
        {
          category: "ETL/ELT Concepts",
          topics: [
            "ETL vs ELT: when to transform before vs after loading (cloud DW favours ELT)",
            "Incremental loading strategies: full refresh, delta load, CDC-based ingestion",
            "Data lineage: tracking data from source to consumption layer",
            "Error handling in pipelines: dead-letter queues, retry logic, alerting",
            "Change Data Capture (CDC): log-based vs trigger-based vs timestamp-based",
            "Idempotency in ETL jobs: ensuring re-runs don't cause duplicate data",
          ],
        },
        {
          ...
          topics: [
            ...
            "CTEs and recursive CTEs for hierarchical data traversal",
            "Query execution plans: understanding full scan vs index seek, hash join vs merge join",
            "Indexing strategies: clustered, non-clustered, bitmap indexes in DW context",
            "Query optimization techniques: predicate pushdown, partition pruning, column pruning",
            "Handling NULL values, data type mismatches, and implicit conversions",
          ],
        },
        {
          category: "Cloud DW Platforms",
          topics: [
            "Snowflake: virtual warehouses, clustering keys, time travel, zero-copy cloning",
            "Google BigQuery: partitioned and clustered tables, BI Engine, streaming inserts",
            "Amazon Redshift: distribution keys, sort keys, VACUUM/ANALYZE maintenance",
            "Azure Synapse Analytics: dedicated vs serverless pools, distribution strategies",
            "Cost optimization techniques: auto-suspend, result caching, query concurrency management",
          ],
        },
        {
          category: "Data Modeling",
          topics: [
            "Dimensional modeling: bus matrix, identifying facts vs dimensions",
            "Normalization (1NF–3NF) and when to denormalize for DW performance",
            "Data vault 2.0: hub-satellite-link model for agile DW development",
            "Aggregation layers: summary tables, materialized views, pre-aggregated rollups",
        ...
        },
        {
          ...
          topics: [
            ...
            "Materialized views: refresh strategies, staleness trade-offs",
            "Caching at multiple layers: result cache, metadata cache, BI tool cache",
            "Parallel query execution and resource management in cloud DW",
            "Statistics maintenance: why stale statistics degrade query plans",
          ],
        },
        {
          category: "Data Integration",
          topics: [
            "Batch vs streaming ingestion: Lambda architecture, Kappa architecture",
            "API-based data ingestion: REST, GraphQL, webhooks as DW sources",
            "Data replication tools: Fivetran, Airbyte, AWS Glue, Azure Data Factory",
            "Schema evolution handling: backward/forward compatibility strategies",
            "Event-driven architecture: Kafka integration for real-time DW patterns",
          ],
        },
        {
          category: "Monitoring & Governance",
          topics: [
            "SLA management: defining, measuring, and alerting on pipeline SLAs",
            "Data quality checks at ingestion, transformation, and serving layers",
            "Audit tables: tracking row counts, timestamps, load status for every batch",
            "Access control in cloud DW: row-level security, column masking, role-based access",
            "Data cataloguing: documenting tables, owners, refresh schedules, business glossary",
          ],
        },
      ],
      tipsToCrack: [
        "Know Kimball vs Inmon cold — interviewers love asking which you'd recommend and why; have a nuanced answer ready (Kimball for departmental, Inmon for enterprise-wide)",
        "Practice writing complex SQL on paper or whiteboard: CTEs, window functions, multi-level joins with GROUP BY — these come up in almost every DWE technical round",
        "Be ready to explain SCD Type 2 implementation in detail: the SQL to insert new rows while closing old ones, including effective-date logic",
        "Understand partitioning and clustering in at least one cloud DW (Snowflake, BigQuery, or Redshift) — explain how you'd choose a partition key for a billion-row fact table",
        "Show hands-on experience with dbt — even if limited, know what a dbt model, test, and snapshot is; this tool is now industry-standard for DW transformations",
        "Explain your approach to handling late-arriving data and how it impacts historical fact table accuracy",
        "Prepare a STAR story about a DW performance problem you solved: what was the slow query, what did you find in the execution plan, and how did you fix it",
        "Discuss data quality validation strategies in pipelines — great expectations, dbt tests, or custom reconciliation scripts show maturity",
        "For senior roles, be ready for system design questions: 'Design a DW for an e-commerce company processing 10M orders/day' — practice end-to-end architecture answers",
        "Know cost optimization in cloud DW: result caching, auto-suspend, right-sizing warehouses, and avoiding SELECT * on large tables",
        "Ask insightful questions: current DW stack, biggest pain points in their pipelines, team structure between data engineering and analytics engineering",
      ],
    },
  },
  ...
  "data-governance-analyst": {
    freeCourses: [
      {
        name: "Data Governance Fundamentals – DAMA Overview",
        url: "https://www.youtube.com/watch?v=0KW9OFQtSZI",
      ...
      {
        name: "Introduction to Data Governance – Coursera",
        url: "https://www.coursera.org/learn/introduction-to-data-governance",
        provider: "LearnQuest",
        platform: "Coursera",
        language: "English",
      ...
      {
        name: "GDPR and Data Privacy Fundamentals",
        url: "https://www.udemy.com/course/gdpr-data-privacy/",
        provider: "Udemy",
        platform: "Udemy",
        language: "English",
        level: "Beginner",
      ...
      {
        name: "Data Quality and Governance in Hindi",
        url: "https://www.youtube.com/playlist?list=PLmXm6G7SEQID_oY3n_iUqL5U7xGnYwCJ8",
        provider: "Intellipaat Hindi",
        platform: "YouTube",
        language: "Hindi",
        level: "Beginner",
      ...
      {
        name: "Data Management Telugu Tutorial",
        url: "https://www.youtube.com/c/TeluguTechTuts",
        provider: "Telugu Tech Tuts",
        platform: "YouTube",
        language: "Telugu",
      ...
      {
        name: "Apache Atlas – Open Source Data Governance",
        url: "https://www.youtube.com/watch?v=lDLJlLByRjQ",
        provider: "Cloudera",
        platform: "YouTube",
        language: "English",
        level: "Intermediate",
      ...
      {
        name: "Metadata Management and Data Catalogs",
      ...
      revisionTopics: [
        {
          ...
          topics: [
            "DAMA-DMBOK: 11 knowledge areas including data governance, data quality, metadata, master data management",
            "Data Governance Operating Model: roles (data owner, steward, custodian, consumer)",
            "Data governance charter: scope, objectives, decision rights, escalation paths",
            "DCAM (Data Management Capability Assessment Model) for maturity assessment",
            "Building a data governance council: composition, meeting cadence, decision-making authority",
            "Data governance metrics: data quality scores, issue resolution time, stewardship compliance rate",
          ],
        },
        {
          category: "Data Quality Management",
          topics: [
            "Six DQ dimensions: accuracy, completeness, consistency, timeliness, validity, uniqueness",
            "Data profiling: statistical analysis to identify anomalies, nulls, outliers, duplicates",
            "Data quality rules: business rules, referential integrity, format validation, range checks",
            "Data quality scorecards: measuring, trending, and reporting DQ metrics to stakeholders",
            "Data cleansing: standardization, deduplication, enrichment, and correction workflows",
            "Root cause analysis for DQ issues: upstream source problems vs downstream transformation bugs",
          ],
        },
        {
          category: "Metadata Management",
          topics: [
            "Business glossary: defining business terms, owners, definitions, and relationships",
            "Technical metadata vs business metadata vs operational metadata",
            "Data lineage: end-to-end traceability from source to consumption layer",
            "Impact analysis: understanding downstream effects of upstream changes",
            "Data catalog tools: Collibra, Alation, Apache Atlas, Microsoft Purview",
            "Metadata governance: who can create, modify, or deprecate business glossary terms",
          ],
        },
        {
          category: "Regulatory Compliance & Privacy",
          topics: [
            "India's Digital Personal Data Protection (DPDP) Act 2023: key provisions and obligations",
            "GDPR principles: lawful basis, data minimization, purpose limitation, subject rights",
            "PII identification and classification: categories of sensitive personal data",
            "Data retention policies: legally mandated retention vs business retention requirements",
            "Consent management: capturing, storing, and honoring data subject consent",
            "Data breach response: notification timelines, reporting obligations under DPDP Act",
          ],
        },
        {
          category: "Master Data Management Basics",
          topics: [
            "Golden record concept: creating a single authoritative view of an entity",
            "Deduplication strategies: deterministic vs probabilistic matching",
            "MDM domains: customer, product, supplier, location master data",
            "Hierarchy management for organizational and product structures",
            "MDM and governance intersection: stewardship workflows for master data approval",
          ],
        },
        {
          category: "Data Classification & Access Control",
          topics: [
            "Data sensitivity classification: public, internal, confidential, restricted levels",
            "Role-based access control (RBAC) and attribute-based access control (ABAC)",
            "Data masking and tokenization techniques for protecting sensitive data",
            "Column-level and row-level security in databases and cloud DW platforms",
        ...
        },
        {
          ...
          topics: [
            "Collibra: workflow engine, data catalog, lineage, and policy management",
            "Alation: data catalog with behavioral analytics and query intelligence",
            "Apache Atlas: open-source metadata management and lineage for Hadoop ecosystems",
            "Microsoft Purview: cloud-native data governance for Azure environments",
            "Informatica Axon: data governance platform integrated with Informatica MDM",
            "SQL for data profiling: writing queries to identify DQ issues across datasets",
          ],
        },
        {
          category: "Communication & Stakeholder Management",
          topics: [
            "Presenting DQ metrics and governance progress to non-technical business stakeholders",
            "Building data literacy programs: training business users on data governance principles",
            "Facilitating data governance committee meetings: agenda, minutes, action items",
            "Influencing without authority: getting data owners to fix upstream quality issues",
            "Creating governance documentation: policies, standards, procedures, and guidelines",
          ],
        },
      ],
      tipsToCrack: [
        "Know DAMA-DMBOK inside out — most DGA interviews start with 'walk me through the DAMA framework' and your depth here signals seniority",
        "Study India's DPDP Act 2023 and map it to GDPR — Indian companies are actively implementing DPDP compliance and this knowledge makes you stand out",
        "Be ready to explain data lineage concepts clearly with a real example: 'This customer revenue figure comes from three source systems merged through this transformation'",
        "Practice describing how you'd build a business glossary from scratch: who you'd interview, how you'd resolve conflicting definitions, and how you'd get sign-off",
        "Show hands-on exposure to at least one data catalog tool (Collibra, Alation, Apache Atlas, or Purview) — even free trial experience counts",
        "Prepare a STAR story about resolving a data quality issue that affected business decisions — quantify the impact and your resolution steps",
        "Demonstrate stakeholder management skills: data governance is 80% people and 20% technology; show how you've driven cultural change around data quality",
        "Know data classification schemes and access control principles — questions about PII handling, data masking, and access approval workflows are common",
        "For scenario questions on data breaches: know the DPDP Act notification timelines (72 hours to DPBI) and the investigation steps you'd follow",
        "Ask thoughtful questions about their current governance maturity, biggest pain points, and how the governance team is structured relative to IT and business",
        "Emphasize your ability to balance compliance requirements with business agility — governance that blocks business value will be rejected; governance that enables it will succeed",
      ],
    },
  },
  ...
  "mdm-specialist": {
    freeCourses: [
      {
        name: "Master Data Management Fundamentals – YouTube",
        url: "https://www.youtube.com/watch?v=LCEqj4WVJIA",
        provider: "Data & Analytics",
        platform: "YouTube",
        language: "English",
        level: "Beginner",
      ...
      {
        name: "Informatica MDM Getting Started",
        url: "https://www.coursera.org/learn/informatica-mdm",
      ...
      {
        name: "Data Modeling for MDM – Complete Course",
        url: "https://www.udemy.com/course/data-modeling-for-beginners/",
        provider: "Udemy",
        platform: "Udemy",
        language: "English",
        level: "Beginner",
      ...
      {
        name: "Master Data Management in Hindi",
      ...
      {
        name: "Data Governance & MDM Telugu Tutorial",
        url: "https://www.youtube.com/c/TeluguTechTuts",
        provider: "Telugu Tech Tuts",
        platform: "YouTube",
        language: "Telugu",
      ...
      },
      {
        ...
        url: "https://www.youtube.com/watch?v=zun3V0wGaE4",
      ...
      {
        name: "IBM MDM Overview and Architecture",
        url: "https://www.ibm.com/training/collection/master-data-management",
        provider: "IBM",
    ...
    interviewGuide: {
      revisionTopics: [
        {
          category: "MDM Fundamentals",
          topics: [
            "Master data vs transactional data vs reference data: definitions and examples",
            "Golden record creation: survivorship rules for determining the authoritative value",
            "Deduplication process: identification, matching, merging, and survivor selection",
            "MDM domains: customer, product, supplier, location, employee master data",
            "Data trust factors: source system reliability scores and confidence levels",
            "MDM lifecycle: create, validate, enrich, govern, distribute, retire",
          ],
        },
        {
          category: "MDM Architecture Styles",
          topics: [
            "Registry style: hub maintains index/cross-references but data stays in source systems",
            "Consolidation style: hub creates read-only master copy from source systems",
            "Coexistence style: hub creates master copy and synchronizes back to source systems",
            "Centralized/transaction hub style: hub becomes the system of record for master data",
            "Choosing the right style: maturity, integration complexity, organizational readiness",
            "Multi-domain MDM vs single-domain MDM architectures",
          ],
        },
        {
          category: "Data Modeling for MDM",
          topics: [
            "Entity resolution: linking records that represent the same real-world entity",
            "Hierarchy management: organizational hierarchies, product categories, geographic hierarchies",
            "Relationship modeling: party-to-party relationships, account-to-contact links",
            "Temporal modeling: tracking history of master data changes over time",
            "Extensible attribute models: handling custom attributes without schema changes",
          ],
        },
        {
          category: "Matching & Deduplication",
          topics: [
            "Deterministic matching: exact match on key identifiers (SSN, email, account number)",
            "Probabilistic matching: Jaro-Winkler, Levenshtein distance, Soundex for fuzzy matches",
            "Match rule configuration: thresholds, weights, and blocking strategies",
            "Survivorship rules: most-recent, most-trusted, longest-value, frequency-based",
            "False positive vs false negative trade-offs in matching threshold tuning",
            "Clerical review queues: routing uncertain matches to human stewards for decision",
          ],
        },
        {
          category: "MDM Tools",
          topics: [
            "Informatica MDM: hub console, landing tables, staging tables, base object design",
            "IBM InfoSphere MDM: entity analytics, probabilistic matching engine",
            "Reltio Cloud MDM: graph-based master data, real-time API-first architecture",
            "Stibo STEP: product information management, multi-domain MDM capabilities",
            "SAP MDG (Master Data Governance): workflow-driven MDM integrated with SAP",
            "Open-source alternatives: MDMX, Talend MDM for smaller implementations",
          ],
        },
        {
          category: "Integration Patterns",
          topics: [
            "Hub-and-spoke integration: all systems route master data changes through the MDM hub",
            "Publish-subscribe pattern: hub publishes golden record updates to subscribed systems",
            "Event-driven MDM: using Kafka/message queues for real-time master data distribution",
            "REST API integration: consuming and publishing master data via API endpoints",
            "Batch vs real-time synchronization: trade-offs for different MDM implementation styles",
          ],
        },
        {
          category: "Data Governance & Stewardship",
          topics: [
            "Stewardship workflow design: creation request, validation, approval, and publish",
            "Role definition: data owner, domain steward, data custodian in MDM context",
            "Exception handling: routing failed validations and match conflicts to stewards",
            "Data quality rules embedded in MDM: pre-merge validation, post-merge checks",
            "Audit trail: tracking every change to master data with user, timestamp, reason",
          ],
        },
        {
          category: "Performance & Scalability",
          topics: [
            "Batch MDM processing: managing large initial load of millions of records",
            "Real-time MDM APIs: latency requirements and caching strategies for golden records",
            "Partitioning master data tables for performance at scale",
            "Index strategy: composite indexes on matching keys for deduplication speed",
            "Horizontal scaling of MDM hubs in cloud-native deployments",
          ],
        },
      ],
      tipsToCrack: [
        "Know all four MDM implementation styles (registry, consolidation, coexistence, centralized hub) and be ready to recommend one given a business scenario with justification",
        "Explain matching and merging algorithms clearly with examples: walk through how you'd set deterministic vs probabilistic matching rules for a customer domain",
        "Be ready to discuss survivorship rules in detail: if two source systems have different phone numbers for the same customer, how do you decide which is the golden record?",
        "Understand the difference between deduplication (finding same entity) and standardization (normalizing formats) — interviewers often confuse these",
        "Show hands-on knowledge of at least one MDM tool — Informatica MDM is most common in India; even describing the hub console, staging tables, and base object design shows real exposure",
        "Discuss hierarchy management for complex org structures: how do you model a conglomerate with subsidiaries and cost centres in MDM?",
        "Explain data stewardship workflow design: who approves a new supplier record? What happens when a duplicate is flagged but the steward disagrees?",
        "For system design questions, be ready to sketch an MDM architecture: source systems → landing zone → standardization → matching → golden record → distribution",
        "Discuss integration patterns between the MDM hub and downstream ERP/CRM systems — event-driven (Kafka) vs batch sync vs API-pull patterns",
        "Prepare a STAR story about a data quality improvement achieved through MDM: how many duplicates were resolved, what business benefit resulted (reduced marketing waste, improved customer experience)",
        "Ask about their current MDM maturity: are they greenfield or replacing legacy MDM? Which domains are in scope? This shows strategic thinking",
      ],
    },
  },
  ...
  "reporting-analyst": {
    freeCourses: [
      {
        name: "Power BI Full Course – Beginner to Advanced",
        url: "https://www.youtube.com/watch?v=AGrl-H87pRU",
        provider: "Guy in a Cube",
        platform: "YouTube",
        language: "English",
        level: "Beginner",
      },
      {
        name: "Power BI in Hindi – Complete Tutorial",
        url: "https://www.youtube.com/playlist?list=PLjVLYmrlmjGfgBKkIFBkMNHciZ0vZqx8p",
        provider: "Intellipaat Hindi",
        platform: "YouTube",
        language: "Hindi",
        level: "Beginner",
      ...
      {
        name: "Power BI Telugu Tutorial",
        url: "https://www.youtube.com/playlist?list=PLrjkTql3jnm9U1tHKUGRgNvTv4G5l2AxP",
        provider: "Telugu Tech Tuts",
        platform: "YouTube",
        language: "Telugu",
        level: "Beginner",
      ...
      {
        name: "Tableau Public – Free Training Videos",
      ...
      {
        name: "Google Data Analytics Certificate – Free Audit",
        url: "https://www.coursera.org/professional-certificates/google-data-analytics",
        provider: "Google",
        platform: "Coursera",
        language: "English",
      ...
      {
        name: "SQL for Analysts – Mode Analytics Tutorial",
        url: "https://mode.com/sql-tutorial/",
        provider: "Mode Analytics",
      ...
      {
        name: "Microsoft PL-300 Power BI Analyst – Free Prep",
      ...
      revisionTopics: [
        {
          ...
          topics: [
            "Complex joins: INNER, LEFT, RIGHT, FULL OUTER, CROSS JOIN with business scenarios",
            "Aggregations: GROUP BY, HAVING, ROLLUP, CUBE for hierarchical summaries",
            "Window functions: RANK, DENSE_RANK, ROW_NUMBER, running totals with SUM OVER",
            "CTEs for multi-step query logic vs subqueries — readability trade-offs",
            "Date/time functions: DATEADD, DATEDIFF, fiscal period calculations",
            "String manipulation functions for data cleansing in reporting queries",
          ],
        },
        {
          category: "BI Tools & Platforms",
          topics: [
            "Power BI: data model, relationships, DAX measures vs calculated columns",
            "Tableau: dimensions vs measures, LOD expressions, table calculations",
            "Looker: LookML models, explores, and derived tables",
            "SSRS: report builder, datasets, parameters, subscriptions, delivery schedules",
            "Excel: PivotTables, Power Query, advanced formulas for quick analysis",
            "Self-service BI governance: certified datasets vs personal datasets in Power BI",
          ],
        },
        {
          category: "DAX & Calculated Fields",
          topics: [
            "DAX fundamentals: row context vs filter context — the most common interview trip-up",
            "CALCULATE function: modifying filter context for custom aggregations",
            "Time intelligence functions: YTD, QTD, MTD, SAMEPERIODLASTYEAR",
            "RELATED and RELATEDTABLE for multi-table calculations",
            "Performance optimization: avoiding complex calculated columns on large tables",
            "Tableau equivalent: FIXED, INCLUDE, EXCLUDE LOD expressions",
          ],
        },
        {
          category: "Data Visualization Principles",
          topics: [
            "Chart selection: when to use bar, line, scatter, pie, waterfall, heatmap",
            "Pre-attentive attributes: color, size, position, shape to direct attention",
            "Dashboard design: Z-pattern layout, KPI cards at top, drill-down hierarchy",
            "Data-ink ratio: removing chart junk, gridlines, and unnecessary decoration",
            "Color theory for data: sequential, diverging, qualitative palettes; accessibility",
            "Storytelling with data: context → insight → action structure in presentations",
          ],
        },
        {
          category: "Report Design & Development",
          topics: [
            "Parameterized reports: dynamic date ranges, region filters, product category toggles",
            "Drill-through and drill-down: navigating from summary to detail level",
            "Scheduled reports: automated delivery via email subscriptions in SSRS and Power BI",
            "Report documentation: field definitions, data sources, refresh schedules, owners",
            "Row-level security: restricting report data visibility by user role or region",
          ],
        },
        {
          category: "KPIs & Business Metrics",
          topics: [
            "Defining good KPIs: SMART criteria applied to business metrics",
            "Common business metrics: CAC, LTV, churn rate, NPS, conversion rate, MoM growth",
            "OKR framework: Objectives and Key Results and translating them into BI dashboards",
            "Metric trees: breaking top-line metrics into contributing sub-metrics",
            "Variance analysis: actual vs budget vs forecast, explaining variance drivers",
          ],
        },
        {
          category: "Statistical Concepts",
          topics: [
            "Averages: mean vs median vs mode — when each is appropriate for business reporting",
            "Percentages, ratios, and growth rates: calculating MoM, YoY, CAGR correctly",
            "Distribution concepts: outlier detection and its impact on average-based KPIs",
            "Correlation vs causation: communicating statistical findings responsibly",
            "Cohort analysis: tracking behaviour of user groups over time",
          ],
        },
        {
          category: "Communication & Stakeholder Management",
          topics: [
            "Requirements gathering: translating vague business questions into specific data queries",
            "Presenting insights to non-technical audience: avoid jargon, lead with conclusion",
            "Handling data discrepancies: when two reports show different numbers, investigation process",
            "Managing ad hoc report requests vs strategic reporting roadmap priorities",
            "Report QA process: peer review, data validation, sense-checking against known benchmarks",
          ],
        },
      ],
      tipsToCrack: [
        "Be ready to explain your dashboard design decisions: 'Why did you choose a bar chart here instead of a line chart?' — interviewers test visual reasoning, not just tool skills",
        "Know DAX context thoroughly — row context vs filter context is the #1 interview topic for Power BI Reporting Analyst roles; practice with CALCULATE and time intelligence functions",
        "Prepare to explain a complex data trend in plain business language: 'Revenue dipped 12% in Q3 because of X' — the ability to translate numbers to narrative is highly valued",
        "Describe your requirements-gathering process: how do you turn a manager's vague ask ('I want a sales dashboard') into specific, agreed metrics and dimensions?",
        "Show experience with self-service BI: explain how you've trained business users to use dashboards independently, reducing ad-hoc report requests to your team",
        "Explain your QA process for reports: how do you validate that the numbers are correct before publishing to senior leadership?",
        "Know how to handle data discrepancies — when Finance and Sales show different revenue numbers, what's your investigation process? This is a very common scenario question",
        "Discuss performance optimization for large datasets: DirectQuery vs Import mode in Power BI, aggregation tables, partitioned data models",
        "Prepare a case study answer: 'Walk me through a dashboard you built from scratch' — have clear story with business problem, data sources used, key metrics, design choices, and business outcome",
        "Know row-level security implementation — restricting report visibility by region or role is a standard enterprise requirement that gets tested",
        "Emphasize your ability to translate business questions into SQL queries — a Reporting Analyst who can write their own queries without depending on engineers is far more valuable",
      ],
    },
  },
  ...
  "data-migration-specialist": {
    freeCourses: [
      {
        name: "SSIS Full Course – SQL Server Integration Services",
        url: "https://www.youtube.com/watch?v=XU15e-oEBqg",
        provider: "WiseOwlTutorials",
        platform: "YouTube",
        language: "English",
        level: "Intermediate",
      },
      {
        name: "AWS Database Migration Service (DMS) Tutorial",
        url: "https://www.youtube.com/watch?v=ouia1Sc5QGo",
        provider: "AWS",
        platform: "YouTube",
        language: "English",
        level: "Intermediate",
      ...
      {
        name: "Azure Data Factory for Data Migration",
        url: "https://learn.microsoft.com/en-us/training/paths/data-integration-scale-azure-data-factory/",
        provider: "Microsoft Learn",
        platform: "Microsoft Learn",
        language: "English",
        level: "Intermediate",
      ...
      {
        name: "Data Migration Concepts in Hindi",
        url: "https://www.youtube.com/playlist?list=PLrjkTql3jnm8_mSQYHOdqBm0LNYsiFZvp",
        provider: "Intellipaat Hindi",
        platform: "YouTube",
        language: "Hindi",
        level: "Beginner",
      ...
      {
        name: "ETL and Data Migration Telugu Tutorial",
        url: "https://www.youtube.com/c/TeluguTechTuts",
        provider: "Telugu Tech Tuts",
        platform: "YouTube",
        language: "Telugu",
      ...
      {
        name: "Talend Open Studio – Free ETL Tool Tutorial",
        url: "https://www.youtube.com/watch?v=W_BITfqf6q4",
        provider: "Talend",
        platform: "YouTube",
        language: "English",
        level: "Beginner",
      ...
      {
        name: "SQL for Data Migration and Transformation",
        url: "https://mode.com/sql-tutorial/",
        provider: "Mode Analytics",
        platform: "Mode Analytics",
        language: "English",
    ...
    interviewGuide: {
      revisionTopics: [
        {
          category: "Migration Planning & Strategy",
          topics: [
            "Migration assessment: inventory of source systems, data volumes, complexity, dependencies",
            "Migration approaches: big-bang (single cutover) vs phased migration vs parallel run",
            "Scope definition: what data migrates, what gets archived, what gets retired",
            "Risk assessment and mitigation: top migration risks and contingency plans",
            "Migration project phases: discovery → analysis → design → build → test → cutover → hypercare",
            "Stakeholder alignment: sign-off on scope, timelines, success criteria before build starts",
          ],
        },
        {
          category: "ETL Development",
          topics: [
            "Extraction patterns: full extract vs incremental extract vs CDC-based extraction",
            "Transformation logic: data type conversions, format harmonization, business rule application",
            "Loading strategies: bulk insert, UPSERT, merge statements for target population",
            "Error handling: reject records to error tables, log errors with source reference keys",
            "Idempotency: ensuring repeated pipeline runs don't create duplicates in target",
            "ETL performance: parallel processing, bulk operations, temp table strategies",
          ],
        },
        {
          category: "Data Mapping & Transformation",
          topics: [
            "Source-to-target mapping document: field-level specification with transformation rules",
            "Data type compatibility: handling type widening/narrowing, implicit conversion risks",
            "Business rule documentation: derived fields, lookup translations, conditional logic",
            "Handling NULL values: NULL propagation vs default value substitution decisions",
            "Code value mapping: translating source lookup codes to target system values",
            "Splitting and merging fields: concatenation, parsing of composite keys and names",
          ],
        },
        {
          category: "Data Quality & Validation",
          topics: [
            "Pre-migration profiling: identify nulls, duplicates, outliers, and constraint violations before build",
            "Reconciliation methods: row count, checksum, hash comparison between source and target",
            "Post-migration validation: business rule checks, referential integrity verification",
            "Data quality acceptance criteria: agreed thresholds before go-live sign-off",
            "Defect tracking: logging, prioritizing, and resolving data quality issues found in testing",
            "Business validation testing (UAT): involving business stakeholders to verify migrated data",
          ],
        },
        {
          category: "Migration Tools",
          topics: [
            "SSIS (SQL Server Integration Services): packages, control flow, data flow, connection managers",
            "Talend Open Studio: job design, components, context variables, error handling",
            "AWS DMS (Database Migration Service): replication instances, endpoints, CDC migration",
            "Azure Data Factory: pipelines, linked services, datasets, mapping data flows",
            "Python-based migration: pandas/SQLAlchemy scripts for custom migration requirements",
            "Comparison and reconciliation tools: custom SQL scripts, Great Expectations, Informatica",
          ],
        },
        {
          category: "Testing Strategies",
          topics: [
            "Unit testing transformations: verifying each business rule with representative test cases",
            "Integration testing: end-to-end pipeline testing with full source data volume",
            "UAT (User Acceptance Testing): business users validate migrated data against known records",
            "Parallel run testing: running source and target systems simultaneously to compare outputs",
            "Performance testing: measuring ETL throughput and validating against migration SLAs",
            "Regression testing after fixes: ensuring corrections don't introduce new issues",
          ],
        },
        {
          category: "Cutover & Rollback Planning",
          topics: [
            "Cutover strategy: activities, timelines, and responsibilities for migration weekend",
            "Rollback plan: criteria for triggering rollback, steps to restore source system operation",
            "Go-live checklist: technical checks, business sign-offs, and hypercare support plan",
            "Delta migration: handling data changes that occur during migration execution window",
            "Freeze periods: coordinating source system freeze to prevent data changes during cutover",
            "Hypercare period: post-go-live monitoring, issue triage, and escalation procedures",
          ],
        },
        {
          category: "Cloud Migration Concepts",
          topics: [
            "Lift-and-shift migration: moving data as-is to cloud with minimal transformation",
            "Re-platforming: migrating from on-premise RDBMS to cloud-native services (e.g., Oracle to Aurora)",
            "Database heterogeneous migration: schema conversion tool (AWS SCT), compatibility issues",
            "Cloud data migration patterns: online migration vs offline (SnowBall, Azure Data Box)",
            "Hybrid migration: phased approach with some data in cloud and some on-premise during transition",
          ],
        },
      ],
      tipsToCrack: [
        "Always start your migration story with data profiling — interviewers want to hear that you assess data quality issues before writing a single line of code, not after migration is complete",
        "Be ready to walk through a source-to-target mapping document: describe its structure, how you validate it with business owners, and how you version-control it during the project",
        "Explain your approach to handling data anomalies found during migration: do you fix at source, transform in ETL, or reject and report? Show you think systematically about each type of anomaly",
        "Know cutover weekend planning in detail: what's on your go/no-go checklist? When do you trigger rollback? Have a clear answer showing project management maturity",
        "Demonstrate reconciliation skills: explain how you validate 50 million records migrated correctly — row counts are necessary but not sufficient; show hash/checksum validation and business rule checks",
        "Discuss incremental vs full-load migration trade-offs: full loads are simpler but require longer downtime; incremental requires CDC and careful delta handling",
        "Explain how you communicate migration status and risks to stakeholders: weekly dashboards, issue logs, and go/no-go decision gates show professional project execution",
        "Know cloud migration patterns — especially database migration from on-premise Oracle/SQL Server to AWS RDS/Aurora or Azure SQL; AWS DMS and Azure DMS are commonly tested",
        "Prepare for scenario questions: 'Your migration has been running for 6 hours, it's 3am, and you find 2% of records failed validation — what do you do?' Show calm, systematic decision-making",
        "Emphasize your testing discipline: unit testing transformations, UAT with business users, and parallel run testing signal a mature specialist rather than someone who just runs the pipeline and hopes for the best",
        "Ask about their current migration context: is it cloud migration, system replacement, or consolidation? What's the data volume and timeline? This helps you tailor follow-up answers and shows strategic thinking",
      ],
    },
  },
};
